...
def escolher_modelo():
    ...
    if escolha == "1":
        return "../saved models/h5/to_convert/full_cnn/recreated_model_tf24.h5"
    elif escolha == "2":
        return "../saved models/h5/to_convert/distillation/distillation_tf241.h5"
    elif escolha == "3":
        return "../saved models/h5/to_convert/ultra_distilattion/ultra_dist_tf241.h5"
